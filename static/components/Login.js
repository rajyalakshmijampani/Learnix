export default {
    ...
    <div class="row">
        <div class="col">
            <img src="http://localhost:5000/static/images/home.png" style="width:100%; height :100vh; background-size: cover;"/>
        </div>
        <div class="col" style="text-align: center;align-items:center">
            <a class="navbar-brand" href="/">
                <img src="http://localhost:5000/static/images/logo.png" alt="Learnix" height="300" style="margin-top:3vh;">
            </a>
    ...
    methods: {
        async login() {
            ...
            if (res.ok) {
                ...
                if (data.role=='user') this.$router.push({path : '/userdashboard'})
            }
            else{
